...
1. 先讲第一种怎么操作,首先Git Bash进入当前项目目录
...
我个人更喜欢使用reabse多一点，没办法，我自己是一个强迫症晚期患者，看工作树呈一条完美的直线展示出来就感觉很爽，看到分叉就难受。然后就是大多数公司的编程方式和开发准则也不同，有些公司喜欢merge多一些，有些公司则更倾向于使用rebase。所以都会用才是正解。小孩子才做选择题，大人只会都要。
